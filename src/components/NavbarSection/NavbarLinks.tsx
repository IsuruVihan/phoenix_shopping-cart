  ...
  return (
    <>
      <Navbar className="navbar-links mt-4 mb-3 py-0 mx-4">
        <Nav className="ms-2">
          <NavDropdown title="Categories" id="collapsible-nav-dropdown" className="mx-2 rounded-1 outline-green py-0 px-1">
          ...
          <Button variant="outline-danger" id="btnPricing" className="mx-2 my-auto">
