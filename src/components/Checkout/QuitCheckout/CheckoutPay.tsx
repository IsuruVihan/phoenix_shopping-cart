...
const CheckoutPay: FC<CheckoutPayProps> = (props) => {
  const {onOrderButtonClick} = props;
  ...
  return (
    <Row className="checkout-pay mx-0">
      ...
      <Col className="order px-0 text-end mt-4 mb-5" xs={12}>
        <Button className="order-btn btn btn-primary" size="sm" onClick={onOrderButtonClick}>
          Order
        </Button>
      </Col>
    </Row>
